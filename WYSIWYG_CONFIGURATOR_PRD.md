...
- **Блок Widget script URL:** поле ввода с иконкой ссылки, кнопки Copy и Edit; border-bottom; при фокусе — акцент #ff592c; при копировании — зелёная подсветка кнопки Copy
...
| Кнопка копирования URL | Copy (иконка) |
| Кнопка редактирования URL | Edit (иконка) |
