...
${initStr}
  ...
  function formatParams(params) {
    ...
    if (params.cardRadius !== undefined && params.cardRadius !== 8) out.cardRadius = String(params.cardRadius);
    if (params.detailCardRadius !== undefined && params.detailCardRadius !== 8) out.detailCardRadius = String(params.detailCardRadius);
    return out;
  }
